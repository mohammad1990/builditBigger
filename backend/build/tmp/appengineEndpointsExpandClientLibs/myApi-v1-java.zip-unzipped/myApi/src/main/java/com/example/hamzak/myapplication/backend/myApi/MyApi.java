 ...
 * on 2016-05-26 at 23:35:01 UTC 
 * Modify at your own risk.
 */

package com.example.hamzak.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-1294.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.example.hamzak.myapplication.backend.myApi.model.MyBean}
   * @return the request
   */
  public SayHi sayHi(com.example.hamzak.myapplication.backend.myApi.model.MyBean content) throws java.io.IOException {
    SayHi result = new SayHi(content);
    initialize(result);
    return result;
  }

  public class SayHi extends MyApiRequest<com.example.hamzak.myapplication.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SayHi(com.example.hamzak.myapplication.backend.myApi.model.MyBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.hamzak.myapplication.backend.myApi.model.MyBean.class);
    }
